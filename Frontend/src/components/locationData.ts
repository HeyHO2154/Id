interface SigunguData {
  ...
  export const sigunguData: SigunguData = {
    "서울특별시": [
    ...
    "강원도": [
      "춘천시", "원주시", "강릉시", "속초시", "삼척시", "홍천군", "횡성군", "영월군",
      "평창군", "철원군", "화천군", "양구군", "인제군", "고성군", "양양군"
    ],
    "충청북도": [
    ...
    "충청남도": [
      "천안시", "공주시", "보령시", "부여군", "홍성군", "예산군", "태안군"
    ],
    "전라북도": [
      "전주시", "군산시", "익산시", "정읍시", "남원시", "김제시", "완주군", "진안군",
      "무주군", "장수군", "임실군", "순천시", "목포시", "여수시", "순천군", "완도군",
      "진도군", "신안군"
    ],
    "전라남도": [
      "여수시", "순천시", "나주시", "광양시", "담양군", "곡성군", "구례군", "고흥군",
    ...
    "경상북도": [
      ...
      "영화군", "청계군", "고령군", "성주군", "칠원군", "예산군", "화양군", "호미군",
      "화확군", "영광군", "장성군", "완도군", "진도군", "신안군"
    ],
    "경상남도": [
